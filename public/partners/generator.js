let eventReader = async () => {
  ...
  let partnerSubject = Object.keys(parnerList)
  let eachDateContent = "";

  for (let Subject of partnerSubject) {

    let SubjectPartners = parnerList[Subject]['partners']

    for (let item of SubjectPartners){
      ...
      var cardBodyContent = `
        <div class="card-body">
            <div class="row">
              ...
              <h5>${parnerList[Subject]['badge']}</h5>
              <h3>${item["title"]}</h3>
